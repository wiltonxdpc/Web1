...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
  <center><h1>Jogo Da Memória <img src="imagens/estrela-nada.png"><img src="imagens/estrela-preenchida.png"><img src="imagens/estrela-preenchida.png"></h1></center>
</head>
<body>
<div class="container">
   <div class="row">
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modalwin">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <center><a href="index.php"><button type="button" class="btn btn-success" >Jogar Novamente</button></center></a>
      </div>
    </div>
    </div>
  </div>
